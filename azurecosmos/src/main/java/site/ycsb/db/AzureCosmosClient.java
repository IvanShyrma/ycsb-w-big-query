...
public class AzureCosmosClient extends DB {
  ...
  protected static CosmosDatabase database;
  ...
  public Status scan(String table, String startkey, int recordcount, Set<String> fields,
    ...
    try {
      ...
      LOGGER.info("query " + querySpec.getQueryText());
  ...
  public Status update(String table, String key, Map<String, ByteIterator> values) {
    ...
    for (int attempt = 0; attempt < NUM_UPDATE_ATTEMPTS; attempt++) {
      try {
        ...
        CosmosItemResponse<ObjectNode> response = container.readItem(key, pk, ObjectNode.class);
